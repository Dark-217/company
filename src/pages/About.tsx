  ...
  const services = [
    {
      ...
      title: t("about.section3.services.service1.title"),
      description: t("about.section3.services.service1.description"),
    },
    {
      icon: (
        <>
      ...
      title: t("about.section3.services.service2.title"),
      description: t("about.section3.services.service2.description"),
    },
    {
      icon: (
        <>
      ...
      title: t("about.section3.services.service3.title"),
      description: t("about.section3.services.service3.description"),
    },
    {
      icon: (
        <>
      ...
      title: t("about.section3.services.service4.title"),
      description: t("about.section3.services.service4.description"),
    },
  ];
  ...
  return (
    <>
      <section className="bg-[#292d33] text-white">
        <div className="w-[calc(50%+170px)] sm:w-[calc(50%+270px)] md:w-[calc(50%+360px)] lg:w-[calc(50%+470px)] xl:w-[calc(50%+570px)] ml-auto">
          <div className="flex flex-wrap">
            <div className="flex flex-col justify-center min-w-full md:min-w-[42%] max-w-[42%]">
              <div className="pt-[50px] pr-[70px] pb-[30px] pl-2.5 sm:pt-[65px] sm:pr-[170px] sm:pl-[30px] md:p-[30px] lg:py-[55px] lg:px-10 flex flex-col justify-center">
                <h2 className="text-[40px] font-semibold sm:text-5xl lg:text-6xl xl:text-[65px] font-[Ubuntu]">
                  {t("about.section1.title")}
                </h2>
                <Button className="mt-[35px] mr-auto" to="contact">
                  {t("contactus")}
                </Button>
              </div>
            </div>
      ...
      <section className="text-center">
        <div className="flex flex-col justify-center w-[340px] sm:w-[540px] md:w-[720px] lg:w-[940px] xl:w-[1140px] m-auto">
          <h2 className="mt-[60px] lg:mt-[70px] text-[40px] sm:text-5xl lg:text-6xl xl:text-[65px] font-[Ubuntu] font-semibold">
      ...
      <section className="bg-[#292d33] text-center">
        <div className="flex flex-col justify-center w-[340px] sm:w-[540px] md:w-[720px] lg:w-[940px] xl:w-[1140px] m-auto">
          <h2 className="mt-[60px] text-[40px] font-semibold sm:text-5xl lg:text-6xl xl:text-[65px] font-[Ubuntu] text-[#eb6928]">
            {t("about.section3.title")}
          </h2>
          <div className="mt-[67px] lg:mt-[94px] mb-[60px]">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[30px]">
              {services.map((service, index) => (
                <AboutService key={index} data={service} />
              ))}
            </div>
          </div>
        </div>
      ...
      <section>
        <div className="flex flex-col justify-center w-[340px] sm:w-[540px] md:w-[720px] lg:w-[940px] xl:w-[1140px] min-h-[1050px] sm:min-h-[1037px] md:min-h-[1044px] lg:min-h-[1156px] xl:min-h-[1134px] m-auto">
          <div className="relative w-[273px] sm:w-[529px] lg:w-[666px] h-[160px] sm:h-[338px] lg:h-[315px] mt-[60px] xl:mt-[522px] mr-auto bg-[#eb6928]"></div>
          <div className="relative w-[300px] sm:w-[446px] md:w-[471px] h-[190px] sm:h-[550px] lg:h-[637px] -mt-[349px] sm:-mt-[550px] lg:-mt-[757px] xl:-mt-[817px] ml-auto mr-0 sm:mr-[25px] md:mr-0 bg-[#eb6928]"></div>
          <img
            src={image1}
            alt="image1"
          ...
          <div className="relative flex mt-[88px] -mb-[130px] mx-0 sm:-mt-11 sm:ml-[76px] sm:mr-auto sm:-mb-[152px] md:-mt-[67px] md:ml-[119px] lg:-mt-[170px] lg:mr-[143px] lg:-mb-[382px] lg:ml-auto xl:m-[-244px_119px_60px_auto] w-full sm:w-[464px] min-h-[505px] lg:min-h-[470px] bg-white">
            <div className="flex flex-col justify-center px-2.5 sm:px-[30px] py-[30px]">
              ...
              <p className="text-xl mt-10">{t("about.section4.description")}</p>
              <Button className="mt-[30px] mr-auto" to="contact">
                {t("contactus")}
              </Button>
            </div>
          </div>
      ...
      <section className="bg-[#292d33]">
        <div className="flex flex-col justify-center w-[340px] sm:w-[540px] md:w-[720px] lg:w-[940px] xl:w-[1140px] m-auto">
          <div className="max-lg:mt-[95px] my-[60px]">
            <div className="flex flex-wrap bg-[#eb6928]">
              <div className="flex min-w-full md:min-w-[32%] max-w-[32%]">
                <div className="flex-1 flex flex-col justify-center p-[30px]">
                  <img
                    className="w-[168px] h-[168px] lg:w-[238px] lg:h-[238px] xl:w-[262px] xl:h-[262px] ml-0 md:ml-auto mr-auto rounded-full object-cover"
                    src={image5}
                    alt="image5"
                  />
                </div>
              </div>
              <div className="min-w-full md:min-w-[68%] max-w-[68%]">
                <div className="pr-5 sm:pr-[30px] p-[30px] flex flex-col justify-center text-white">
                  <span className="w-16 h-16 mr-auto block">
                    <img src={image6} alt="image6" className="object-contain" />
                  </span>
                  <p className="text-2xl mt-5 mr-auto">
                    {t("about.section5.comment")}
                  </p>
                  <p className="text-lg font-bold italic mt-5">
                    - {t("about.section5.name")},&nbsp;
                    {t("about.section5.role")}
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="bg-[#e5e5e5]">
        <div className="flex flex-col justify-center w-[340px] sm:w-[540px] md:w-[720px] lg:w-[940px] xl:w-[1140px] min-h-[926px] sm:min-h-[999px] md:min-h-[1075px] lg:min-h-[1121px] m-auto">
          <div className="relative w-[222px] sm:w-[451px] h-[366px] sm:h-[432px] md:h-[506px] lg:h-[528px] mt-[60px] mr-auto bg-[#eb6928]"></div>
          <div className="relative w-[274px] sm:w-[471px] h-[192px] sm:h-[383px] lg:h-[521px] xl:h-[637px] -mt-[517px] sm:-mt-[771px] md:-mt-[845px] lg:-mt-[897px] xl:-mt-[915px] mr-0 ml-auto lg:ml-469px xl:ml-auto bg-[#eb6928] "></div>
          <img
            src={image7}
            alt="image7"
            className="relative w-[260px] sm:w-[540px] md:w-[583px] lg:w-[814px] xl:w-[1013px] h-[219px] sm:h-[397px] md:h-[429px] lg:h-[603px] xl:h-[675px] -mt-[145px] sm:-mt-[312px] lg:-mt-[450px] xl:-mt-[566px] ml-auto sm:ml-0 md:ml-16 lg:ml-auto mr-auto xl:mr-[62px] object-cover"
          />
          <div className="relative flex flex-col w-full sm:w-[404px] md:w-[464px] min-h-[486px] md:min-h-[510px] h-auto mt-11 sm:-mt-[85px] md:-mt-[65px] lg:-mt-[203px] xl:-mt-[275px] mx-0 md:mr-auto -mb-[91px] sm:-mb-[279px] lg:-mb-[309px] xl:-mb-[327px] sm:ml-16 bg-white text-[#111]">
            <div className="flex-1 max-sm:px-5 p-[30px] flex flex-col justify-center">
              <h3 className="text-4xl font-bold capitalize font-[Ubuntu]">
